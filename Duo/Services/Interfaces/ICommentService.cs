...
namespace Duo.Services.Interfaces
{
    public interface ICommentService
    {
        ...
        public Task<(List<Comment> AllComments, List<Comment> TopLevelComments, Dictionary<int, List<Comment>> RepliesByParentId)> GetProcessedCommentsByPostId(int postId);
        ...
        public Task<bool> DeleteComment(int commentId, int userId);
